...
// image enlargement
let imageContent = document.querySelectorAll(".item>img");
let imageEnlargementArea = document.querySelector("#img-enlargement-area>img");
console.log(imageContent);

imageContent.forEach((el) => {
  el.addEventListener("click", () => {
    imageEnlargementArea.src = el.src;
  });
});
